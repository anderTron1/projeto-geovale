...
DEFAULT_KEY_INCOME_SPOUSE = '«RENDA_DO_CONJUGE»'
DEFAULT_KEY_PROFESSION_SPOUSE = '«PROFISSAO_DO_CONJUGE»'
...
DEFAULT_KEY_TXT_PROPERTY_IS_PAID_OFF = '«O_IMOVEL_E_QUITADO»'
DEFAULT_KEY_TXT_HOW_LONG_HAS_THE_PROPERTY = '«QUANTO_TEMPO_POSSUI_O_IMOVEL»'
...
def keys_fields():
        keys = [               
                ...
                DEFAULT_KEY_TXT_PROPERTY_IS_PAID_OFF,
...
def keys_fields_spouse():
        keys = [
            ...
            DEFAULT_KEY_INCOME_SPOUSE,
            DEFAULT_KEY_PROFESSION_SPOUSE,
